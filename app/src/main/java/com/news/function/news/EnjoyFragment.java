 ...
 */
public class EnjoyFragment extends BaseFrament {
    private static final String TAG = "EnjoyFragment";
    private static int NEWS_TYPE = 3;
    ...
    public void getNews(){
        if(NetworkUtils.isNetworkAvailable(getActivity())) {
            NetWork.getNetWorkApi()
                    .getEnjoy(Local.SOCIAL_API_KEY, limit, page)
    ...
    class SportAdapter extends BaseAdapter<NewsEntity> {
