 ...
 */
public class TechnoFragment extends BaseFrament {
    private static final String TAG = "TechnoFragment";
    private static int NEWS_TYPE = 6;
    ...
    public void getNews() {
        if(NetworkUtils.isNetworkAvailable(getActivity())) {
            NetWork.getNetWorkApi()
                    .getTechno(Local.SOCIAL_API_KEY, limit, page)
